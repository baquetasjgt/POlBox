...
const ALL_VENUES = [
  {
    ...
    boxes: 2, hours: 'Abierto 24/7', dist: 0.4, rating: 4.9, reviews: 128,
  ...
  },
  {
    ...
    boxes: 3, hours: 'Abierto 24/7', dist: 1.2, rating: 4.8, reviews: 76,
  ...
  },
  {
    ...
    boxes: 2, hours: 'Abierto 24/7', dist: 3.1, rating: 4.7, reviews: 54,
  ...
  },
  {
    ...
    boxes: 2, hours: 'Abierto 24/7', dist: 382, rating: 4.9, reviews: 210,
  ...
  },
  {
    ...
    boxes: 3, hours: 'Abierto 24/7', dist: 383, rating: 4.8, reviews: 167,
  ...
  },
  {
    ...
    boxes: 2, hours: 'Abierto 24/7', dist: 351, rating: 4.8, reviews: 89,
...
// Bounding boxes + origin for pin % calculation (west, north, dLon, dLat)
const CITY_CFG = {
